...
import com.example.carrotmarket.remote.SignInView


class LoginActivity:AppCompatActivity (), SignInView {
    lateinit var binding:ActivityLoginBinding
    //lateinit var frag_binding:FragmentMyBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.emailSignUpButton.setOnClickListener{//회원가입 보내줌
            val intent = Intent(this, SignupActivity::class.java)//화면전환
